package com.qsptechnologies.PageFactory_model.modules.listeners;
...
public class Listener extends TestBase implements ITestListener {
		...
		if (!result.isSuccess()) {
			...
			try {
				String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath()
						+ "\\src\\test\\resources\\screenshot\\failed\\" + methodName + "_" + formater + ".png";
	...
	public void onTestSkipped(ITestResult result) {
		...
		// "****************************************************");
	  if (skip == "No") { // True only when Run Mode is Y
